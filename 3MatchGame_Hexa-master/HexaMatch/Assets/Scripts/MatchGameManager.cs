...
public class MatchGameManager : MonoBehaviour
{
	private int CurrentLevel
	{
		get
		{
			if (PlayerPrefs.HasKey("CapCakersdfgsdgdaSYfyhsd"))
				return PlayerPrefs.GetInt("CapCakersdfgsdgdaSYfyhsd");
			return 1;
		}
		set
		{
			PlayerPrefs.SetInt("CapCakersdfgsdgdaSYfyhsd", value);
		}
	}
	...
	private void Update()
	{
		...
		if(CurrentLevel > EffectManager.MaxLeve)
			EffectManager.MaxLeve = CurrentLevel;
	...
	{
        CurrentLevel = 1;
        Scene nextScene = SceneManager.CreateScene("SweetCupcakesMenuScene");
