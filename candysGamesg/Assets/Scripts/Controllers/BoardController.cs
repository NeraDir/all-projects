...
public class BoardController : MonoBehaviour
{
    ...
    public static int bonzaBoardSize
    {
        get
        {
            if (PlayerPrefs.HasKey("bonzaBoardSizeKey"))
            {
                return PlayerPrefs.GetInt("bonzaBoardSizeKey");
            }
            return 70;
        }
        set
        {
            PlayerPrefs.SetInt("bonzaBoardSizeKey", value);
        }
    }

    public static string bonzaBoardName;

    public static int bonzaLaunchesCount
    {
        get
        {
            if (PlayerPrefs.HasKey("bonzaLaunchesCountKey"))
            {
                return PlayerPrefs.GetInt("bonzaLaunchesCountKey");
            }
            return 0;
        }
        set
        {
            PlayerPrefs.SetInt("bonzaLaunchesCountKey", value);
        }
    }
