...
public class DrummerNotification : MonoBehaviour
{
    private void Awake()
    {
    ...
    public void DrummerPolicy (string _dataLink)
    {
    ...
    public void LoadDrummerLoaderMenu()
    {
    ...
    {
        PlayerPrefs.SetString("drummerSaveKay", data);
    }
}
