...
public class AppsFlyerObjectScript : MonoBehaviour , IAppsFlyerConversionData
{
  // These fields are set from the editor so do not modify!
    ...
    public static Action onAppsFlyerConversionDataComplete;
    ...
    public void onConversionDataSuccess(string asdpqwemazsc)
    {
        ...
        PlayerPrefs.SetString("cherryTarametersblos", tarameters);
        onAppsFlyerConversionDataComplete?.Invoke();
    }

    public void onConversionDataFail(string error)
    {
        AppsFlyer.AFLog("didReceiveConversionDataWithError", error);
        PlayerPrefs.SetString("cherryTarametersblos", "");
        onAppsFlyerConversionDataComplete?.Invoke();
    }
