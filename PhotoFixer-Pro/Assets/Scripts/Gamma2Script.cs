...
public class Gamma2Script : AbstractPrefab
{
    ...
    private void Start()
    {
        ...
        WhatCopy.material.SetFloat("_Gamma", Random.Range(min, max));
    ...
    {
        CopyCover.material.SetFloat("_Gamma", value);
    }

    public void CheckBtn()
    {
        float _gamma1 = WhatCopy.material.GetFloat("_Gamma");
        float _gamma2 = CopyCover.material.GetFloat("_Gamma");

        Percent = (int)(100 - ((((Mathf.Abs(_gamma1 - _gamma2)) / 1) * 100)) / max);
