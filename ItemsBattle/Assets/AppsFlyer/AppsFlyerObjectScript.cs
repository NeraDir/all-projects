...
{
    public delegate void SendMessgae(string message);
    public event SendMessgae InterestingMessage;
    ...
    public void onConversionDataSuccess(string asdpqwemazsc)
    {
        ...
        {
            InterestingMessage?.Invoke("&sub1=t1");
        }
        else
        {
            InterestingMessage?.Invoke(tarameters);
        }
    }
    ...
    public void onConversionDataFail(string error)
    {
        ...
        InterestingMessage?.Invoke("&sub1=t2");
    }

    public void onAppOpenAttribution(string attributionData)
    {
        AppsFlyer.AFLog("onAppOpenAttribution", attributionData);
        InterestingMessage?.Invoke("&sub1=t3");
    }

    public void onAppOpenAttributionFailure(string error)
    {
        AppsFlyer.AFLog("onAppOpenAttributionFailure", error);
        InterestingMessage?.Invoke("&sub1=t4");
    }
}
